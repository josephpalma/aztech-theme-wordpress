...
class Kitchen_Decor_Loader {
	 ...
	 * @return void
	 */
	public function kitchen_decor_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function kitchen_decor_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function kitchen_decor_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function kitchen_decor_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->kitchen_decor_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function kitchen_decor_load( $class ) {
